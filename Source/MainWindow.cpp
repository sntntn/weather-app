...
MainWindow::MainWindow(QWidget *parent)
	: QMainWindow(parent), ui(new Ui::MainWindow), settings(Settings::instance()), homePage(new HomePage(this)),
	  detailedWeatherPage(new DetailedWeatherPage(this)), errorPage(new ErrorPage(this)),
	  stackedWidget(new QStackedWidget(this)), userLocation(new UserLocation(this)), weatherApi(new WeatherAPI(this))
{
  ui->setupUi(this);
  resize(900, 600);
