...
TEST_CASE("DetailedWeatherData Construction") {
    ...
    DetailedWeatherData weatherData(location, 25, 200, true, QTimeZone("Europe/Belgrade"),
                                    10, 15, 180, 30, 5, 0.5, 7, 60, 10, 1010,
                                    hourlyTemperature, fullHourlyTemperature, hourlyCode,
                                    hourlyIsDay, hourlyTimeStamp, weeklyMaxTemp, weeklyMinTemp,
                                    weeklyCode, sunrise, sunset, weeklyDayName);
