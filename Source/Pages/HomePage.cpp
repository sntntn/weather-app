...
HomePage::HomePage(QWidget *parent)
	: Page{parent}, mainLayout(new QVBoxLayout(this)), upperLayout(new QHBoxLayout()), searchBar(new QLineEdit()),
	  settingsButton(new QPushButton()), refreshButton(new QPushButton()), scrollArea(new QScrollArea()),
	  scrollAreaContents(new QWidget()), widgetsLayout(new QGridLayout()), completer(new CustomCompleter(this)),
	  debounceTimer(new QTimer(this)), settingsPixmap(settingsIconPath), settingsIcon(settingsPixmap),
	  refreshPixmap(refreshIconPath), refreshIcon(refreshPixmap)
{
